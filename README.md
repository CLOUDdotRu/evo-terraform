...
- [Cloud.ru Evolution Terraform Provider 1.3.1](#cloudru-evolution-terraform-provider-130)
...
# Cloud.ru Evolution Terraform Provider 1.3.1
...
``` bash
cd \
  && curl -L --create-dirs -o .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/darwin_arm64/terraform-provider-cloud_1.3.1_darwin_arm64 \
  https://github.com/CLOUDdotRu/evo-terraform/releases/download/1.3.1/terraform-provider-cloud_1.3.1_darwin_arm64 \
  && chmod +x .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/darwin_arm64/terraform-provider-cloud_1.3.1_darwin_arm64
```
...
``` bash
cd \  
  && curl -L --create-dirs -o .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/darwin_amd64/terraform-provider-cloud_1.3.1_darwin_amd64 \
  https://github.com/CLOUDdotRu/evo-terraform/releases/download/1.3.1/terraform-provider-cloud_1.3.1_darwin_amd64 \
  && chmod +x .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/darwin_amd64/terraform-provider-cloud_1.3.1_darwin_amd64
```
...
``` bash
cd \
  && curl -L --create-dirs -o .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/linux_amd64/terraform-provider-cloud_1.3.1_linux_amd64 \
  https://github.com/CLOUDdotRu/evo-terraform/releases/download/1.3.1/terraform-provider-cloud_1.3.1_linux_amd64 \
  && chmod +x .terraform.d/plugins/cloud.ru/cloudru/cloud/1.3.1/linux_amd64/terraform-provider-cloud_1.3.1_linux_amd64
```
...
``` bash
curl -L -o terraform-provider-cloud_1.3.1_windows_amd64 https://github.com/CLOUDdotRu/evo-terraform/releases/download/1.3.1/terraform-provider-cloud_1.3.1_windows_amd64
mkdir -p %APPDATA%\terraform.d\plugins\cloud.ru\cloudru\cloud\1.3.1\windows_amd64
move terraform-provider-cloud_1.3.1_windows_amd64 %APPDATA%\terraform.d\plugins\cloud.ru\cloudru\cloud\1.3.1\windows_amd64\
```
