...
resource "cloudru_evolution_baremetal_reserved_server" "resource_reserved_server" {
  ...
  name = "Server name"
  # Поле hostname является неизменяемым. При изменении значения ресурс будет пересоздан.
  hostname    = "hostname"
  description = "Description"
  # Поле public_key_id является неизменяемым. При изменении значения ресурс будет пересоздан.
  public_key_id = "940cfc96-7410-4add-aecd-dcf858edc341"
  # Поле login является неизменяемым. При изменении значения ресурс будет пересоздан.
  login         = "user"
